  ...
  timeline: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          title: 'การรวมใจสู่ "รุ่นสมานฉันท์" (2552)',
          text: 'บันทึกหน้าสำคัญในช่วงเวลาที่คาบเกี่ยวกับการยึดอำนาจของ คสช. ภายในรั้วโรงเรียนเกิดเหตุการณ์เรียกร้องความถูกต้องจนนำไปสู่การรวมตัวครั้งใหญ่ แต่ด้วยสติ การหันหน้ามาพูดคุยกันด้วยเหตุผลของทุกฝ่าย จึงกลายเป็นที่มาของชื่อ "รุ่นสมานฉันท์" ที่แสดงถึงความสามัคคีอันบริสุทธิ์ของพวกเรา',
        },
        {
