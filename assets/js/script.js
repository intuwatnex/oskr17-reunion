...
const CONFIG = {
  ...
  timeline: [
    {
      year: '2552 (2009)',
      title: 'เข้าเรียน ม.1 สวนกุหลาบฯ รังสิต',
    ...
    },
    {
      ...
      text: '<span class="font-semibold text-ink">พิกัดที่คิดถึง:</span> โต๊ะหินอ่อนข้างตึกสิรินธร 1 (ตึก 9 ชั้น) ที่พวกเราชอบไปนั่งพักผ่อน มุมสงบแอร์เย็น ๆ ในห้องสมุดตึก 3 และที่ขาดไม่ได้คือ "บัตรแลกอาหารกลางวันสุดเท่" ไปต่อแถวซื้อของกินที่โรงอาหาร<br><br><span class="font-semibold text-ink">อาจารย์ที่เคารพและรัก:</span> คุณครูทุกท่านที่คอยดูแลอบรมสั่งสอน ยืนดักตรวจระเบียบเครื่องแต่งกายที่ประตูโรงเรียนทุกเช้า ความเข้มงวดในวันนั้นกลายเป็นความทรงจำที่อบอุ่นในวันนี้<br><br><span class="font-semibold text-ink">หน้าบันทึกบนโลกโซเชียล:</span> ยุค BlackBerry สู่ iPhone 4 ยุคเริ่มเล่น Facebook ไปจนถึงโมเมนต์ล้อมวงดีดกีตาร์ร้องเพลงกันช่วงพักกลางวัน',
    },
    {
      year: '2557 (2014)',
      title: 'กำเนิด "รุ่นสมานฉันท์"',
      text: 'บันทึกหน้าสำคัญในช่วงเวลาที่คาบเกี่ยวกับการยึดอำนาจของ คสช. ภายในรั้วโรงเรียนเกิดเหตุการณ์เรียกร้องความถูกต้องจนนำไปสู่การรวมตัวครั้งใหญ่ แต่ด้วยสติและการหันหน้ามาพูดคุยกันด้วยเหตุผลของทุกฝ่าย จึงกลายเป็นที่มาของชื่อ "รุ่นสมานฉันท์" ที่แสดงถึงความสามัคคีอันบริสุทธิ์ของพวกเรา',
    },
    {
      year: '2557 (2014)',
      title: 'สำเร็จการศึกษา ม.6',
