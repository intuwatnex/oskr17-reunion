...
const TICKET_TIER_DISPLAY = {
  ...
  'Final Call': { title: 'Final Call Ticket', badge: 'FINAL CALL', className: 'bg-amber-500/15 text-amber-600', detail: '🎉บัตรเข้าร่วมงาน จะไม่ได้รับของที่ระลึก เนื่องจากสินค้าต้องสั่งผลิตล่วงหน้า' },
